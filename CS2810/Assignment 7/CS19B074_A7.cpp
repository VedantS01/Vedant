/**-----------------------------------------------------------------
 * 
 *  FILE            :           CS19B074_A7.cpp 
 * 
 *  PURPOSE         :           Introduces a template class MST, which is a child of another template class Graph
 *                              Computes Maximum Spanning Tree for undirected continous graphs using
 *                              Prim's algorithm and Kruskal's algorithm
 * 
 *  NOTE            :           template class Graph was created in the Assignment 7, file : CS19B074_A6.cpp
 *                              Used the same class.
 * 
 *  VERSION         :           1.2
